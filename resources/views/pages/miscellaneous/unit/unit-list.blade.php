...
<div class="container-fluid py-3">
    <div class="row mt-4">
        <div class="col-md-12 d-flex">
            @if(havePermission('unit.add'))
            <button id="toggleButton" class="btn btn-info mb-3 ml-1"><i class="fas fa-plus-circle me-2"></i>Add Unit</button>
            @endif
        </div>
        @if ($errors->any())
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="name">Add Unit <span class="text-danger">*</span></label>
            ...
            <table id="example1" class="table dataTable table-hover">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            @if(havePermission('unit.edit'))
                            <a href="{{ route('unit.edit', $row->id) }}" class="text-info px-2"><i class="fas fa-edit"></i> </a>
                            @endif
                            @if(havePermission('unit.destroy'))
                            <button class="btn btn-default text-danger btn-sm px-2 delete-unit" data-id="{{ $row->id }}"><i class="fa-solid fa-trash"></i> </button>
                            @endif
                        </td>
