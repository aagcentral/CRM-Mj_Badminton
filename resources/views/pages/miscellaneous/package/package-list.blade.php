            ...
            <table id="example1" class="table dataTable table-hover">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            @if(havePermission('package.edit'))
                            <a href="{{ route('package.edit', $row->id) }}" class="text-info px-2"><i class="fas fa-edit"></i> </a>
                            @endif
                            @if(havePermission('package.destroy'))
                            <button class="btn btn-default text-danger btn-sm px-2 delete-package" data-id="{{ $row->id }}"><i class="fa-solid fa-trash"></i> </button>
                            @endif
                        </td>
